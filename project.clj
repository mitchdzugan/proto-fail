(defproject proto-fail "0.1.27"
  :description "FIXME: write description"
  :url "https://github.com/mitchdzugan/proto-fail"
    ...
    {:builds
     {:app
      {:source-paths ["src" "env/dev/cljs"]
       :figwheel     {:on-jsload "proto-fail.test-page/mount-root"}
       :compiler     {:main          proto-fail.dev
                      :asset-path    "/js/out"
    ...
    {:builds
     {:test-cljs
      {:source-paths ["src" "test"]
       :compiler     {:main          proto-fail.runner
  ...
  :aliases {"update-readme-version" ["shell"
                                     "sed"
                                     "-i"
                                     "s/\\\\[proto-fail \"[0-9.]*\"\\\\]/[proto-fail \"${:version}\"]/"
                                     "README.md"]
            "test-cljs"
            ["do"
             ["clean"]
